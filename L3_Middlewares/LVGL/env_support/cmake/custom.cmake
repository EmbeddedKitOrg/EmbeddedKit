...
if(NOT LV_CONF_BUILD_DISABLE_EXAMPLES AND EXAMPLE_SOURCES)
...
if(NOT LV_CONF_BUILD_DISABLE_DEMOS AND DEMO_SOURCES)
...
# configure_file("${LVGL_ROOT_DIR}/lvgl.pc.in" lvgl.pc @ONLY)  # 已删除 lvgl.pc.in，跳过 pkg-config 配置
configure_file("${LVGL_ROOT_DIR}/lv_version.h.in" lv_version.h @ONLY)

# install(  # 已删除 lvgl.pc.in，跳过 pkg-config 安装
